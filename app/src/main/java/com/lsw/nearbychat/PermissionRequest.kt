...
fun requestAllPermissions(self: MainActivity)
{
    ...
    if (ActivityCompat.checkSelfPermission(self, Manifest.permission.CHANGE_WIFI_STATE) != PackageManager.PERMISSION_GRANTED)
        permissions.add(Manifest.permission.CHANGE_WIFI_STATE);
    if (ActivityCompat.checkSelfPermission(self, Manifest.permission.BLUETOOTH) != PackageManager.PERMISSION_GRANTED)
    ...
    if (ActivityCompat.checkSelfPermission(self, Manifest.permission.READ_NEARBY_STREAMING_POLICY) != PackageManager.PERMISSION_GRANTED)
        permissions.add(Manifest.permission.READ_NEARBY_STREAMING_POLICY);
